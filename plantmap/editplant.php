...
{ 
  ...
  $measurement = mysqli_real_escape_string($conn, $_POST['measurement']);
   ...
   $var1 = rand(1111,9999);  // generate random number in $var1 variable
    ...
    $result = mysqli_query($conn, "UPDATE plants SET image='$dst_db',status='$status',common_name='$common_name',scientific_name='$scientific_name',family='$family',category='$category',measurement='$measurement' WHERE id=$id");
            ...
            <form  method="post" action="editplant.php" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-sm-5 text-center">
                  <img  class="img-circle" width="300" height="300"  src="<?php echo $dst_db; ?>"><br><br>
