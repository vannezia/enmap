...
?>
                     ...
                     <td><?php echo $res['status']; ?></td>
                      <td><?php echo $res['category']; ?></td>
                       ...
                       <td><a href="editplant.php?id=<?php echo $res['id'];?>" class="glyphicon glyphicon-edit btn btn-warning btn-sm" ></a>  <a href="delete.php?id=<?php echo $res['id'];?>" onClick="return checkdelete()"><button type='button' class='btn btn-danger btn-sm'><span class='glyphicon glyphicon-trash' ></span></button></a></td>
